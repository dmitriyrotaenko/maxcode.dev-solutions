/*
Реализуйте класс HttpRouter, который умеет обрабатывать http-запросы. Класс должен поддерживать всего два метода: addHandler и runRequest. С помощью addHandler можно добавить функцию, которая должна вызываться для определенного эндпоинта и http-метода. С помощью runRequest можно «сделать запрос».
